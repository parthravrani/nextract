---
layout: default
title: "45% Profit Boost: DoorDash Menu Engineering Case Study"
description: "Restaurant group increased profit 45% using DoorDash menu intelligence. Analyzed 20,000+ restaurants for pricing and item optimization. Menu engineering."
...
<div class="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8">
  ...
  <p class="text-lg"><strong>Industry:</strong> Restaurant Operations</p>
</div>

## The Challenge

Low profit margins on delivery orders due to suboptimal menu pricing and item selection. Needed data-driven menu engineering approach.

## Our Solution

Analyzed 20,000+ restaurants on DoorDash tracking menu items, pricing strategies, portion sizes, combos, and profitability indicators across cuisines.
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-6 my-12">
  ...
  <div class="text-center p-6 bg-white border border-gray-200">
    <div class="text-4xl font-black text-blue-600 mb-2">12</div>
    <div class="text-sm font-bold text-gray-600 uppercase">Locations</div>
  </div>
  <div class="text-center p-6 bg-white border border-gray-200">
    <div class="text-4xl font-black text-blue-600 mb-2">20,000+</div>
    <div class="text-sm font-bold text-gray-600 uppercase">Menus Analyzed</div>
  </div>
  <div class="text-center p-6 bg-white border border-gray-200">
    <div class="text-4xl font-black text-blue-600 mb-2">$500K</div>
    <div class="text-sm font-bold text-gray-600 uppercase">Additional Profit</div>
  </div>
</div>
