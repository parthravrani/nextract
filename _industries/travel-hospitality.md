        ...
        <div class="container mx-auto px-6 max-w-7xl relative z-10">
            <div class="max-w-5xl mx-auto">
                ...
                <div class="mt-8 p-6 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-lg shadow-lg">
                    ...
                    <p class="text-lg font-semibold mb-1">Get 30% OFF on all travel & hospitality data extraction services</p>
        ...
        <div class="container mx-auto px-6 max-w-7xl">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="text-xl mb-8 opacity-90">
                    Get <strong class="text-3xl">30% OFF</strong> on all travel & hospitality data extraction services
                </p>
