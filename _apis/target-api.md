...
- **Real-time Data**: Get product data updates as they happen on Target
...
- **Pricing**: Current prices, sale prices, clearance prices, price history
...
```
GET /api/v1/target/product
GET /api/v1/target/reviews
GET /api/v1/target/search
GET /api/v1/target/inventory
```
...
- **Retail Platforms**: Power your retail platform with real-time Target data
