...
- **Real-time Data**: Get restaurant data updates as they happen on DoorDash
...
```
GET /api/v1/doordash/restaurants
GET /api/v1/doordash/menus
GET /api/v1/doordash/reviews
GET /api/v1/doordash/search
```
