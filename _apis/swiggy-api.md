...
- **Real-time Data**: Get restaurant data updates as they happen on Swiggy
...
```
GET /api/v1/swiggy/restaurants
GET /api/v1/swiggy/menus
GET /api/v1/swiggy/reviews
GET /api/v1/swiggy/search
```
