...
## What We Extract from BigBasket
...
```
GET /api/v1/bigbasket/product/{id}
GET /api/v1/bigbasket/search?q={query}
GET /api/v1/bigbasket/category/{category_id}
GET /api/v1/bigbasket/reviews/{id}
GET /api/v1/bigbasket/trending
GET /api/v1/bigbasket/best-sellers
```
...
# Get data
data = client.bigbasket.get_product('product_id')
print(f"Title: {data['title']}")
print(f"Price: {data['price']}")
print(f"Rating: {data['rating']}")

# Search
results = client.bigbasket.search(query='search_term')
for item in results:
...
// Get data
const data = await client.bigbasket.getProduct('product_id');
